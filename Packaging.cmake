...
if(NSIS_PATH)
	...
	set(CPACK_NSIS_MUI_ICON  "${CMAKE_SOURCE_DIR}/Resources/Logo.bmp")
	set(CPACK_NSIS_MUI_UNIICON  "${CMAKE_SOURCE_DIR}/Resources/Logo.bmp")
	set(CPACK_NSIS_MUI_HEADERIMAGE_BITMAP  "${CMAKE_SOURCE_DIR}/Resources/Logo.bmp")
	set(CPACK_NSIS_MUI_WELCOMEFINISH_BITMAP "${CMAKE_SOURCE_DIR}/Resources/Logo.bmp")
else()
