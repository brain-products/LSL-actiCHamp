...
if(NSIS_PATH)
	...
	message(STATUS dir:  " ${PREFERRED_INSTALL_DIR}${INSTALL_DIR}\\actiCHamp\ LSL\ Connector.exe")
	set(CPACK_NSIS_INSTALLED_ICON_NAME "\\\\bin\\\\actiCHamp\ LSL\ Connector.exe")
	...
	set(CPACK_NSIS_MUI_ICON  "${CMAKE_SOURCE_DIR}\\\\Resources\\\\BV_LSL.ico")
	set(CPACK_NSIS_MUI_UNIICON  "${CMAKE_SOURCE_DIR}\\\\Resources\\\\BV_LSL.ico")
	set(CPACK_NSIS_MUI_HEADERIMAGE_BITMAP  "${CMAKE_SOURCE_DIR}\\\\Resources\\\\BV_LSL.ico")
	set(CPACK_NSIS_MUI_WELCOMEFINISH_BITMAP "${CMAKE_SOURCE_DIR}\\\\Resources\\\\BV_LSL.ico")
else()
